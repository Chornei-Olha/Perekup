...
export default function RegistrationPage() {
  ...
  return (
    <div className="bg-gradient-to-br from-[#8B0000] to-black text-white flex items-center justify-center p-4 sm:p-8">
      <div>
        <Header />
        <div className="min-h-screen max-w-7xl w-full grid grid-cols-1 sm:grid-cols-2 gap-8 items-center">
          <div>
